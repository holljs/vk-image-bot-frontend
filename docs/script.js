// script.js (РАБОЧАЯ БАЗА + ИДЕАЛЬНОЕ СКАЧИВАНИЕ ПО ССЫЛКЕ)
...
// ВНИМАНИЕ: downloadButton мы теперь будем искать локально, так как он может быть <a>

// --- 1. ИНИЦИАЛИЗАЦИЯ (РАБОЧАЯ) ---
